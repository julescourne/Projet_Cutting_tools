                    ...
                    dbc.Row([
                        ...
                        html.Div([
                            ...
                            html.Div([
                                ...
                                html.Div([
                                    dcc.Dropdown(id='mode-value', options=self.modes_courbe, style={'display': 'inline-block', 'padding-left': '2vh', 'width': '30vh'})
                                ]),
                                html.Div([
                            ...
                            dcc.Graph(id='courbe-chart', style={'width': '100%'}),
                            ], className='content', id='content_courbe', style={'display': 'none', 'height': '140vh'}),
                    ])
